...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>ladun/futala/css/vendor/bootstrap.min.css">

    <link rel="preconnect" href="https://fonts.gstatic.com">
    <link href="https://fonts.googleapis.com/css2?family=Lato:wght@700&display=swap" rel="stylesheet">

    <!-- Icon Font CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>ladun/futala/css/vendor/ionicons.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/css/all.min.css">

    <!-- Plugins CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>ladun/futala/css/plugins/slick.css">
    <link rel="stylesheet" href="<?= base_url() ?>ladun/futala/css/plugins/animation.css">
    <link rel="stylesheet" href="<?= base_url() ?>ladun/futala/css/plugins/jqueryui.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>https://s3-id-jkt-1.kilatstorage.id/ebunga/ebunga-cdn/css-lib/stisla/style.css">
    ...
    <link rel="stylesheet" href="<?= base_url() ?>ladun/futala/css/style.css">
                                        ...
                                        <div class="top-info-wrap text-right">
                                            <ul class="top-info">
                                                ...
                                                <li><a href="#">(+62) 821-6751-1111</a></li>
                                                    ...
                                                    <li><a href="{{ url('/auth/account')}}">You are not logged in, please login</a>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="shop.html">Product</a>
                                            <ul class="mega-menu">
                                                ...
                                                <li style="padding-bottom: 12px;padding-left:12px;"><a href="#!"></a>
                                                    <ul>
