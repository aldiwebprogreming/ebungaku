...
<footer>
    ...
    <!-- Modernizer JS -->
    <script src="<?= base_url() ?>ladun/futala/js/vendor/modernizr-3.6.0.min.js"></script>
    <!-- jQuery JS -->
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <!-- Bootstrap JS -->
    <script src="<?= base_url() ?>ladun/futala/js/vendor/popper.min.js"></script>
    <script src="<?= base_url() ?>ladun/futala/js/vendor/bootstrap.min.js"></script>

    <!-- Slick Slider JS -->
    <script src="<?= base_url() ?>ladun/futala/js/plugins/slick.min.js"></script>
    <!--  Jquery ui JS -->
    <script src="<?= base_url() ?>ladun/futala/js/plugins/jqueryui.min.js"></script>
    <!--  Scrollup JS -->
    <script src="<?= base_url() ?>ladun/futala/js/plugins/scrollup.min.js"></script>
    <script src="<?= base_url() ?>ladun/futala/js/plugins/ajax-contact.js"></script>
    ...
    <script src="<?= base_url() ?>ladun/futala/js/main.js"></script>
   <!--  <script src="ladun/custom_js"></script> -->
